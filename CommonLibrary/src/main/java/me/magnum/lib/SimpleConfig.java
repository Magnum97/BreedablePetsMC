...
public class SimpleConfig extends YamlConfiguration {
	 ...
	 */
	public SimpleConfig (String fileName, JavaPlugin plugin) {
		this(fileName, plugin,true);
	}
	 ...
	 */
	public SimpleConfig (String fileName, JavaPlugin plugin, boolean useDefaults) {
		this.plugin = plugin;
		// First, set the defaults from which we update your config.
		// The defaults are in your src/main/resources folder
		if (useDefaults) {
